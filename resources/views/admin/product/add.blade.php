        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="productName" value="{{old('name')}}" onkeyup="ChangeToSlug()" class="form-control @error('name') is-invalid @enderror">
                    @error('name')
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="slug" id="slug" value="{{old('slug')}}" class="form-control @error('slug') is-invalid @enderror w-75">
                    @error('slug')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="row">   
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="price" id="" value="{{old('price')}}" class="form-control @error('price') is-invalid @enderror">
                    @error('price')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="sale_price" id="" value="{{old('sale_price')}}" class="form-control @error('sale_price') is-invalid @enderror w-75">
                    @error('sale_price')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label p-1">
                            <input class="form-check-input" type="radio" name="statusPro" id="" value="1" checked>Còn hàng
                        </label>
                        <label class="form-check-label p-1">
                            <input class="form-check-input" type="radio" name="statusPro" id="" value="0">Hết hàng
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <input type="checkbox" value="1" name="stock" id="">
                </div>
            </div>
            <div class="col-lg-10">
                <div class="form-group">
                    ...
                    <br>
                    <textarea name="description" id="editor1" cols="80" rows="5"></textarea>
                    @error('description')
